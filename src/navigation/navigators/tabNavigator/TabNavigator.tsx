    ...
    return (
        <TabNavigator.Navigator initialRouteName={RouteNames.NotesView}>
            <TabNavigator.Screen
                ...
                component={NotesView}
                options={createBottomTabNavigationOptions({ iconName: Icons.Notes, labelKey: "notes" })}
            />
            <TabNavigator.Screen
                name={RouteNames.RemindersView}
                component={RemindersView}
                options={createBottomTabNavigationOptions({ iconName: Icons.Reminders, labelKey: "reminders" })} />
