...
export function Login() {
    const { state, onEmailChange, onPasswordChange, login, onCreateUser } = useLogin();
    ...
    return (
        <View style={styles.container}>
            ...
            <TextInput style={styles.field} placeholder={LocaleUtils.getLocalizedString("password")} value={state.password} onChangeText={onPasswordChange} secureTextEntry={true} />
            ...
            <TouchableOpacity style={styles.footer} onPress={onCreateUser}>
                <Text style={styles.footerText}>{LocaleUtils.getLocalizedString("no_user")}</Text>
            </TouchableOpacity>
        </View>
    )
}